...
var NetworkMessage = class _NetworkMessage {
  ...
  static decode(data) {
    const reader = new import_io.BigEndianReader(data);
    ...
    const messageReader = new import_io.BigEndianReader(
